...
public class Lisence : EntityBase<int>
{
    ...
    private Lisence(string lisenceKey, DateTime issuedOn, DateTime expiresOn)
    {
    ...
    public static Lisence Create(string lisenceKey, DateTime issuedOn, DateTime expiresOn)
    {
        ...
        return new Lisence(lisenceKey, issuedOn, expiresOn);
    }
}
